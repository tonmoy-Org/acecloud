        ...
        <SectionContainer>
            <Container maxWidth='lg'>
                ...
                >
                    ...
                    <HeroText>Build Websites And <br /> Customize Every Detail</HeroText>
                    <SubText>
                        Simplify your process with professional web design tools. Create websites, track progress, and achieve your goals with precision.
                    </SubText>
                    ...
                    <div className="px-2">
                        ...
                        <div className="w-full flex justify-between">
                            ...
                            <div className="px-2 lg:px-3 xl:px-4 w-full mb-5 lg:w-8/16 4xl:w-7/16 text-[#BABABA]">
                                {["Brand Identity", "UI/UX Design", "Web Development", "Graphic Design", "Motion Graphics"].map((service, index) => (
                                    <a
                                        key={index}
