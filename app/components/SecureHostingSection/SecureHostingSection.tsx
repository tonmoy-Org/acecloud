        ...
        <SectionContainer>
            <Container maxWidth='lg'>
                ...
                >
                    ...
                    <HeroText>Secure Hosting for <br /> Ultimate Protection</HeroText>
                    <SubText>
                        Keep your website and data safe with advanced encryption and reliable hosting solutions. Experience peace of mind with top-tier security.
                    </SubText>
                        ...
                        <div className="w-full flex justify-between">
                            <div className="px-2 w-full mb-5 lg:mb-0 lg:w-7/16">
                                <h2 className="text-xl md:text-2.5xl xl:text-3xl 4xl:text-4xl font-sans-primary tracking-tight text-[#BABABA] dark:text-grayDark-100 leading-tight text-balance pr-10 lg:pr-0">
                                    Ensure your website's security with our reliable and secure hosting services.
                                </h2>
                            </div>
                            <div className="px-2 lg:px-3 xl:px-4 w-full mb-5 lg:w-8/16 4xl:w-7/16 text-[#BABABA]">
                                {["SSL Encryption", "Regular Backups", "DDoS Protection", "Firewall Security", "24/7 Monitoring"].map((service, index) => (
                                    <a
                                        key={index}
