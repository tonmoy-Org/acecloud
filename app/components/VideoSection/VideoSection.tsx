      ...
      <Container maxWidth="lg">
        <Box className="relative py-10 md:py-20 w-full">
          ...
          >
            ...
            <video className="w-full h-auto rounded-lg shadow-[0_0_20px_rgba(156,64,255,0.6)] border-2 border-[rgba(29,78,216,0.5)]" width="100%" height="auto" autoPlay muted loop playsInline>
