            ...
            >
                ...
                >
                    <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0">
                        <div
                            className={`absolute inset-auto right-1/2 h-56 overflow-visible w-[30rem] bg-gradient-conic from-[#1D4ED8] via-transparent to-transparent text-white transition-opacity duration-1000 delay-500 ease-out ${isInView ? 'opacity-100' : 'opacity-0'
                        ...
                        <div
                            className={`absolute inset-auto left-1/2 h-56 w-[30rem] bg-gradient-conic from-transparent via-transparent to-[#1D4ED8] text-white transition-opacity duration-1000 delay-500 ease-out ${isInView ? 'opacity-100' : 'opacity-0'
