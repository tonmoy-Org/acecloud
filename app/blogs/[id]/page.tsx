    ...
    return (
        <Container maxWidth='lg' sx={{ pt: 20, pb: 10 }}>
            <Card sx={{ backgroundColor: 'hsl(220, 65%, 3.52%)', color: 'white', maxWidth: { xs: '100%', md: '70%' }, mx: 'auto' }}>
                ...
                <Typography gutterBottom sx={{ fontWeight: 'bold', fontSize: '2.5rem' }}>
                    {blogPost.title}
                </Typography>
                <CardMedia
                    component="img"
                ...
                <CardContent sx={{ padding: '0 !important', my: 2 }}>
                    <Typography gutterBottom sx={{ color: 'hsl(220 10% 54.4%)', fontSize: '1.125rem' }}>
                        {blogPost.shortDescription}
                    </Typography>
                    <Typography sx={{ mt: 3, fontSize: '.875rem' }}>
